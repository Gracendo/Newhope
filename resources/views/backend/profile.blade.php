...
<head>
  ...
  <title>Profile | ra-admin - Premium Admin Template</title>
  <!--font-awesome-css-->
  ...
  <!-- glight css -->
  <link rel="stylesheet" href="{{asset('assets/backend/vendor/glightbox/glightbox.min.css')}}">

  <!-- filepond css -->
  <link rel="stylesheet" href="{{asset('assets/backend/vendor/filepond/filepond.css')}}">
  <link rel="stylesheet" href="{{asset('assets/backend/vendor/filepond/image-preview.min.css')}}">
...
<body>
                  ...
                  <div class="card-body profile-friends">
                    <div class="d-flex align-items-center">
                      <div class="h-40 w-40 d-flex-center b-r-50 overflow-hidden bg-dark">
                        <img src="{{asset('assets/backend/images/avtar/2.png')}}" alt="image" class="img-fluid">
                      </div>
                    ...
                    <div class="d-flex align-items-center mt-3">
                      <div class="h-40 w-40 d-flex-center b-r-50 overflow-hidden bg-primary">
                        <img src="{{asset('assets/backend/images/avtar/10.png')}}" alt="image" class="img-fluid">
                      </div>
                      <div class="flex-grow-1 ps-2">
                    ...
                    <div class="d-flex align-items-center mt-3">
                      <div class="h-40 w-40 d-flex-center b-r-50 overflow-hidden bg-success">
                        <img src="{{asset('assets/backend/images/avtar/14.png')}}" alt="image" class="img-fluid">
                      </div>
                      <div class="flex-grow-1 ps-2">
                    ...
                    <div class="d-flex align-items-center mt-3">
                      <div class="h-40 w-40 d-flex-center b-r-50 overflow-hidden bg-warning">
                        <img src="{{asset('assets/backend/images/avtar/16.png')}}" alt="image" class="img-fluid">
                      </div>
                      <div class="flex-grow-1 ps-2">
                        <div class="fw-medium"> Fleta Walsh </div>
                    ...
                    <div class="d-flex align-items-center mt-3">
                      <div class="h-40 w-40 d-flex-center b-r-50 overflow-hidden bg-danger">
                        <img src="{{asset('assets/backend/images/avtar/13.png')}}" alt="image" class="img-fluid">
                      </div>
                      <div class="flex-grow-1 ps-2">
                    ...
                    <div class="d-flex align-items-center mt-3">
                      <div class="h-40 w-40 d-flex-center b-r-50 overflow-hidden bg-info">
                        <img src="{{asset('assets/backend/images/avtar/1.png')}}" alt="image" class="img-fluid">
                      </div>
                      <div class="flex-grow-1 ps-2">
                        <div class="fw-medium"> Bette Hagenes</div>
                        <div class="text-muted f-s-12">Wed Designer</div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="post-div">
                      <div class="row g-2 my-2">
                        <div class="col-6">
                          <a href="{{asset('assets/backend/images/profile-app/19.jpg')}}" class="glightbox" data-glightbox="type: image; zoomable: true;">
                            <img src="{{asset('assets/backend/images/profile-app/19.jpg')}}" class="w-100 rounded" alt="">
                          </a>
                        </div>
                        <div class="col-6">
                          <a href="{{asset('assets/backend/images/profile-app/27.jpg')}}" class="glightbox" data-glightbox="type: image; zoomable: true;">
                            <img src="{{asset('assets/backend/images/profile-app/27.jpg')}}" class="w-100 rounded" alt="">
                          </a>
                        </div>
                        <div class="col-4">
                          <a href="{{asset('assets/backend/images/profile-app/28.jpg')}}" class="glightbox" data-glightbox="type: image; zoomable: true;">
                            <img src="{{asset('assets/backend/images/profile-app/28.jpg')}}" class="w-100 rounded" alt="">
                          </a>
                        </div>
                        <div class="col-4">
                          <a href="{{asset('assets/backend/images/profile-app/29.jpg')}}" class="glightbox" data-glightbox="type: image; zoomable: true;">
                            <img src="{{asset('assets/backend/images/profile-app/29.jpg')}}" class="w-100 rounded" alt="">
                          </a>
                        </div>
                        <div class="col-4">
                          <a href="{{asset('assets/backend/images/profile-app/30.jpg')}}" class="glightbox" data-glightbox="type: image; zoomable: true;">
                            <img src="{{asset('assets/backend/images/profile-app/30.jpg')}}" class="w-100 rounded" alt="">
                          </a>
                        </div>
                      </div>
                      ...
                      <div class="card" >
                        ...
                        <div class="card-body">
                          <div class="story-container app-arrow">
                            <div>
                              <a  href="{{asset('assets/backend/images/profile-app/11.jpg')}}" class="glightbox story" data-glightbox="type: image; zoomable: true;">
                                <img src="{{asset('assets/backend/images/profile-app/11.jpg')}}" class="rounded img-fluid" alt="image">
                            ...
                            <div>
                              <a href="{{asset('assets/backend/images/profile-app/12.jpg')}}" class="glightbox story" data-glightbox="type: image; zoomable: true;">
                                <img src="{{asset('assets/backend/images/profile-app/12.jpg')}}" class="rounded img-fluid" alt="image">
                                <div class="h-50 w-50 d-flex-center b-r-50 overflow-hidden story-icon bg-danger">
                                  <img src="{{asset('assets/backend/images/avtar/08.png')}}" alt="image" class="img-fluid">
                                </div>
                              </a>
                            </div>
                            <div>
                              <a href="{{asset('assets/backend/images/profile-app/13.jpg')}}" class="glightbox story" data-glightbox="type: image; zoomable: true;">
                                <img src="{{asset('assets/backend/images/profile-app/13.jpg')}}" class="rounded img-fluid" alt="image">
                                <div class="h-50 w-50 d-flex-center b-r-50 overflow-hidden story-icon bg-secondary">
                                  <img src="{{asset('assets/backend/images/avtar/2.png')}}" alt="image" class="img-fluid">
                                </div>
                              </a>
                            </div>
                            <div>
                              <a href="{{asset('assets/backend/images/profile-app/14.jpg')}}" class="glightbox story" data-glightbox="type: image; zoomable: true;">
                                <img src="{{asset('assets/backend/images/profile-app/14.jpg')}}" class="rounded img-fluid" alt="image">
                                <div class="h-50 w-50 d-flex-center b-r-50 overflow-hidden story-icon bg-dark">
                                  <img src="{{asset('assets/backend/images/avtar/3.png')}}" alt="image" class="img-fluid">
                                </div>
                              </a>
                            </div>
                            <div>
                              <a href="{{asset('assets/backend/images/profile-app/15.jpg')}}" class="glightbox story" data-glightbox="type: image; zoomable: true;">
                                <img src="{{asset('assets/backend/images/profile-app/15.jpg')}}" class="rounded img-fluid" alt="image">
                                <div class="h-50 w-50 d-flex-center b-r-50 overflow-hidden story-icon bg-warning">
                                  <img src="{{asset('assets/backend/images/avtar/07.png')}}" alt="image" class="img-fluid">
                                </div>
                              </a>
                            </div>
                            <div>
                              <a href="{{asset('assets/backend/images/profile-app/16.jpg')}}" class="glightbox story" data-glightbox="type: image; zoomable: true;">
                                <img src="{{asset('assets/backend/images/profile-app/16.jpg')}}" class="rounded img-fluid" alt="image">
                                <div class="h-50 w-50 d-flex-center b-r-50 overflow-hidden story-icon bg-info">
                                  <img src="{{asset('assets/backend/images/avtar/4.png')}}" alt="image" class="img-fluid">
                                </div>
                              </a>
                            </div>
                            <div>
                              <a href="{{asset('assets/backend/images/profile-app/17.jpg')}}" class="glightbox story" data-glightbox="type: image; zoomable: true;">
                                <img src="{{asset('assets/backend/images/profile-app/17.jpg')}}" class="rounded img-fluid" alt="image">
                                <div class="h-45 w-45 d-flex-center b-r-50 overflow-hidden story-icon bg-primary">
                                  <img src="{{asset('assets/backend/images/avtar/5.png')}}" alt="image" class="img-fluid">
                                </div>
                              </a>
                            </div>
                            <div>
                              <a href="{{asset('assets/backend/images/profile-app/18.jpg')}}" class="glightbox story" data-glightbox="type: image; zoomable: true;">
                                <img src="{{asset('assets/backend/images/profile-app/18.jpg')}}" class="rounded img-fluid" alt="image">
                                <div class="h-45 w-45 d-flex-center b-r-50 overflow-hidden story-icon bg-success">
                                  <img src="{{asset('assets/backend/images/avtar/6.png')}}" alt="image" class="img-fluid">
                                </div>
                              </a>
                            </div>
                          </div>
                          ...
                          <div class="col-12">
                            <div class="photos-container">
                              <div class="left-main-img img-box">
                                <a href="{{asset('assets/backend/images/profile-app/20.jpg')}}" class="glightbox"
                                   data-glightbox="type: image; zoomable: true;">
                                  <img src="{{asset('assets/backend/images/profile-app/20.jpg')}}" alt="image">
                              ...
                              <div>
                                <div class="sub">
                                  <div class="img-box">
                                    <a href="{{asset('assets/backend/images/profile-app/21.jpg')}}" class="glightbox" data-glightbox="type: image">
                                    <img src="{{asset('assets/backend/images/profile-app/21.jpg')}}" alt="image">
                                    <div class="transparent-box2">
                                      <div class="captions">
                                        Simple image example
                                      </div>
                                  ...
                                  <div class="img-box"><a href="{{asset('assets/backend/images/profile-app/23.jpg')}}" class="glightbox"
                                                          data-glightbox="type: image"><img src="{{asset('assets/backend/images/profile-app/23.jpg')}}"
                                                                                            alt="image">
                                    <div class="transparent-box2">
                                      <div class="captions">
                                        Simple image example
                                  ...
                                  <div class="img-box"><a href="{{asset('assets/backend/images/profile-app/24.jpg')}}" class="glightbox"
                                                          data-glightbox="type: image"><img src="{{asset('assets/backend/images/profile-app/24.jpg')}}"
                                                                                            alt="image">
                                    <div class="transparent-box2">
                                      <div class="captions">
                                        Simple image example
                                  ...
                                  <div id="multi-link" class="img-box">
                                    <a href="{{asset('assets/backend/images/profile-app/22.jpg')}}" class="glightbox"
                                       data-glightbox="type: image">
                                      <img src="{{asset('assets/backend/images/profile-app/22.jpg')}}" alt="image">
                              ...
                              <div id="more-img" class="extra-images-container hide-element">
                                <a href="{{asset('assets/backend/images/blog-app/01.jpg')}}" class="glightbox"
                                   data-glightbox="type: image"><img src="{{asset('assets/backend/images/blog-app/01.jpg')}}"
                                                                     alt="image"></a>
                                <a href="{{asset('assets/backend/images/blog-app/02.jpg')}}" class="glightbox"
                                   data-glightbox="type: image"><img src="{{asset('assets/backend/images/blog-app/02.jpg')}}"
                                                                     alt="image" ></a>
                                <a href="{{asset('assets/backend/images/blog-app/03.jpg')}}" class="glightbox"
                                   data-glightbox="type: image"><img src="{{asset('assets/backend/images/blog-app/03.jpg')}}"
                                                                     alt="image"></a>
                              </div>
                            </div>
                            ...
                            <div class="photos-container">
                              <div class="left-main-img img-box">
                                <a href="{{asset('assets/backend/images/profile-app/video.mp4')}}" class="glightbox">
                                  <img src="{{asset('assets/backend/images/profile-app/26.jpg')}}" alt="image">
                                  <div class="transparent-box">
                                    <div class="caption">
                              ...
                              <div class="right-main-img img-box">
                                <a href="{{asset('assets/backend/images/profile-app/video.mp4')}}" class="glightbox">
                                  <img src="{{asset('assets/backend/images/profile-app/25.jpg')}}" alt="image">
                                  <div class="transparent-box">
                                    <div class="caption">
                                      <i class="fa-solid fa-play-circle fa-fw"></i>
                                    </div>
                          ...
                          <li class="timeline-section">
                            ...
                            <div class="timeline-content">
                              ...
                              <div class="app-timeline-info-text timeline-border-box me-2 ms-0 mt-3 p-3">
                                <div class="row">
                                  <div class="col-sm-4">
                                           <a href="{{asset('assets/backend/images/draggable/02.jpg')}}" class="glightbox img-hover-zoom" data-glightbox="type: image; zoomable: true;">
                                             <img src="{{asset('assets/backend/images/draggable/02.jpg')}}" class="w-100 rounded" alt="">
                                           </a>
                                  </div>
                                  <div class="col-sm-4">
                                      <a href="{{asset('assets/backend/images/draggable/04.jpg')}}" class="glightbox img-hover-zoom" data-glightbox="type: image; zoomable: true;">
                                        <img src="{{asset('assets/backend/images/draggable/04.jpg')}}" class="w-100 rounded" alt="">
                                      </a>
                                  </div>
                                  <div class="col-sm-4">
                                      <a href="{{asset('assets/backend/images/draggable/01.jpg')}}" class="glightbox img-hover-zoom" data-glightbox="type: image; zoomable: true;">
                                        <img src="{{asset('assets/backend/images/draggable/01.jpg')}}" class="w-100 rounded" alt="">
                                      </a>
                                  </div>
                                </div>
                              </div>
                          ...
                          <div class="card-header">
                            <div class="d-flex align-items-center">
                              <div class="h-40 w-40 d-flex-center b-r-50 overflow-hidden">
                                <img src="{{asset('assets/backend/images/icons/logo2.png')}}" alt="" class="img-fluid">
                              </div>
                              <a href="project_details.html" target="_blank" class="flex-grow-1 px-3">
                              ...
                              <div class="col-6">
                                ...
                                <ul class="avatar-group float-end breadcrumb-start ">
                                  <li class="h-25 w-25 d-flex-center b-r-50 text-bg-danger b-2-light position-relative" data-bs-toggle="tooltip" data-bs-title="Sabrina Torres">
                                    <img src="{{asset('assets/backend/images/avtar/4.png')}}" alt="" class="img-fluid b-r-50 overflow-hidden">
                                  </li>
                                  <li class="h-25 w-25 d-flex-center b-r-50 text-bg-success b-2-light position-relative" data-bs-toggle="tooltip" data-bs-title="Sabrina Torres">
                                    <img src="{{asset('assets/backend/images/avtar/1.png')}}" alt="" class="img-fluid b-r-50 overflow-hidden">
                                  </li>
                      ...
                      <div class="col-12">
                        <div class="card hover-effect">
                          <div class="card-header">
                            <div class="d-flex align-items-center">
                              <div class="h-40 w-40 d-flex-center b-r-50 overflow-hidden">
                                <img src="{{asset('assets/backend/images/icons/logo4.png')}}" alt="" class="img-fluid">
                              </div>
                              <a href="project_details.html" target="_blank" class="flex-grow-1 px-3">
                            ...
                            <div class="row">
                              ...
                              <div class="col-6">
                                ...
                                <ul class="avatar-group float-end breadcrumb-start ">
                                  ...
                                  <li class="h-25 w-25 d-flex-center b-r-50 text-bg-success b-2-light position-relative" data-bs-toggle="tooltip" data-bs-title="Sabrina Torres">
                                    <img src="{{asset('assets/backend/images/avtar/5.png')}}" alt="" class="img-fluid b-r-50 overflow-hidden">
                                  </li>
                                  <li class="text-bg-primary h-25 w-25 d-flex-center b-r-50" data-bs-toggle="tooltip" data-bs-title="5 More">
                                    10+
                                  </li>
                  ...
                  <div id="tab-4" class="tabs-content">
                    ...
                    <div class="card">
                      <div class="card-body">
                        <div class="d-flex align-items-center">
                          <div class="h-45 w-45 d-flex-center b-r-50 overflow-hidden bg-danger">
                            <img src="{{asset('assets/backend/images/avtar/09.png')}}" alt="avtar" class="img-fluid">
                          </div>
                          <div class="flex-grow-1 ps-2 pe-2">
                        ...
                        <div class="Comment-box mb-3">
                          <div class="d-flex align-items-center">
                            <div class="h-45 w-45 d-flex-center b-r-50 overflow-hidden bg-primary">
                              <img src="{{asset('assets/backend/images/avtar/woman.png')}}" alt="" class="img-fluid">
                            </div>
                            <div class="flex-grow-1 ps-2 pe-2">
                            ...
                            <div class="card friend-list-card">
                              <div class="card-body">
                                <div class="d-flex align-items-center">
                                  ...
                                  <a href="./chat.html" target="_blank" class="btn btn-light-success icon-btn b-r-22"> <i class="ti ti-brand-hipchat"></i> </a>
                                </div>
                                ...
                                <ul class="friend-list">
                                  ...
                                  <li class="d-flex align-items-center mt-3 position-relative">
                                    <div class="h-50 w-50 d-flex-center b-r-50 overflow-hidden position-absolute bg-warning">
                                      <img src="{{asset('assets/backend/images/avtar/12.png')}}" alt="image" class="img-fluid">
                                    </div>
                                    <div class="flex-grow-1 mg-s-50">
                    ...
                    <div class="profile-container">
                      ...
                      <div class="person-details">
                        <h5 class="f-w-600">Ninfa Monaldo
                          <img src="{{asset('assets/backend/images/profile-app/01.png')}}" class="w-20 h-20" alt="instagram-check-mark">
                        </h5>
  ...
  <!-- filepond -->
  <script src="{{asset('assets/backend/vendor/filepond/file-encode.min.js')}}"></script>
  <script src="{{asset('assets/backend/vendor/filepond/validate-size.min.js')}}"></script>
  <script src="{{asset('assets/backend/vendor/filepond/validate-type.js')}}"></script>
  <script src="{{asset('assets/backend/vendor/filepond/exif-orientation.min.js')}}"></script>
  <script src="{{asset('assets/backend/vendor/filepond/image-preview.min.js')}}"></script>
  <script src="{{asset('assets/backend/vendor/filepond/filepond.min.js')}}"></script>

  <!-- slick-file -->
  <script src="{{asset('assets/backend/vendor/slick/slick.min.js')}}"></script>
  <script src="{{asset('assets/backend/vendor/shepherdjs/shepherd.js')}}"></script>
