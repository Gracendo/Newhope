...
<head>
    ...
    <title>Forgot Password | ra-admin - Premium Admin Template</title>
        ...
        <main class="w100 ">
            ...
            <div class="app-sign-up">
                <div class="app-container bg-dark">
                    ...
                    <div class="forms-container">
                        ...
                        <div class="signin-signup">
                            <form action="#" class="sign-in-form">
                                ...
                                <div>
                                    <p class="bg-primary-300 px-2 py-3 f-s-12">Enter your email and instructions will be
                                        sent to you!</p>
                                </div>
                                ...
                                <p class="social-text">Create account</p>
                    ...
                    <div class="app-link-sign">
                        <p class="m-0">Already have an account ? <a href="" class="text-underline f-s-16">Sign In</a>
                        </p>
                    </div>
...
<!-- js-->
<script src="{{asset('assets/backend/js/sign_up.js')}}">></script>
